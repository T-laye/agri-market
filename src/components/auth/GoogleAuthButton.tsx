...
export default function GoogleAuthButton({ redirectTo }: { redirectTo: string }) {
	return (
		<form action={signInWithGoogle}>
			...
			<button
				type="submit"
				className="w-full flex items-center justify-center gap-3 rounded-[10px] border-2 border-neutral-200 px-4 py-3 text-sm font-semibold text-neutral-500 duration-150 hover:border-primary hover:bg-primary-100"
			>
				<GoogleIcon />
